...
<section class="flex flex-col md:flex-row justify-between">
    <div class="flex flex-col gap-3">
        <div>
            ...
            <p class="text-gray-600">We're here to help. Reach out to us and we'll get back to you as soon as possible.</p>
        </div>
        ...
        <div class="flex gap-2">
            ...
            <div>  
                <h2 class="font-bold">Response time</h2>
        ...
        <div class="flex gap-2">
            ...
            <div>  
                <h2 class="font-bold">Support hours</h2>
                <p class="text-gray-600">Mon - Fri, 8:00 AM - 6:00 AM (SAST)</p>
            </div>
        </div>
    </div>

    <img class="hidden md:block w-1/2" src="<?= base_url('images/contactus.png') ?>" alt="">
</section>
